        ...
        \section{Usage guide}
                ...
                \subsection{Configuration}
                                ...
                                All settings are automatically saved in a configuration file on change. The most common location for this file is \texttt{~/.config/coral-chords/config.yml}. All settings can be manually changed in the file or by changing them using the GUI.\@
                        {
                                ...
                                CCh is able to remind you to change your instrument's strings regularly. To enable this setting, tick the corresponding box. The interval slider below is set to three months by default but you can change it to your needs.\break
                                ...
                                The ``Search depth'' describes how many results will be listed when searching. The number is not meant literally; it is a multiplier, meaning there will be about 20 additional results for each number more than 1. The default value is 2.\break
