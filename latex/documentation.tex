        ...
        \section{Usage guide}
                ...
                \subsection{Configuration}
                                ...
                                All settings are automatically saved in a configuration file on change. The most common location for this file is \texttt{~/.config/coral-chords/config.yml}. All settings can be manually changed in the file or by changing them using the GUI.\@
                        {
                                ...
                                The ``Search depth'' describes how many results will be listed when searching. The number is not meant literally; it is a multiplier, meaning there will be about 20 additional results for each number more than 2, which is the minimum and the default.
                                ...
                                The ``Header colour'' and ``Chord colour'' settings change the colours of certain elements of a displayed tab. Hex-colour-codes with and without alpha channel are accepted. To restore the default colours, empty the input fields.
                        }
\end{document}