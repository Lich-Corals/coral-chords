...
\begin{document}
        ...
        \section{Project structure}
                ...
                \subsection{Backend}
                        Because the BA still has many tasks, it is subdivided into a bunch of sub modules defined in the code. I'll explain the tasks of each of them in the following sections.
                        ...
                        \subsubsection{System module}
                                As the name suggests, every direct interaction with the user's system is managed by this module. It is mainly used to read and write files and for detection of the currently running song on Spotify.
        ...
        \section{Functionality details}
                \subsection{Getting the data from UG}
                        ...
                        \subsubsection{Scraping UG's data}
                                ...
                                As soon as the data is extracted, it is saved %...
